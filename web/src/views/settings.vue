            ...
            <div class="md:w-1/2">
                <div class="card flex flex-col gap-4">
                    ...
                    <div class="grid grid-cols-12 gap-2">
                        ...
                        <div class="col-span-12 md:col-span-9">
                            <InputGroup>
                                <InputText id="server/addr" type="text" v-model="refs.server.addr.value" placeholder="MQTT Server Address" />
                                <Button type="button" class="mr-2 mb-2" icon="pi pi-save" :disabled="disabled" :loading="refs.server.addr.loading.value" @click="load($event)" />
                            </InputGroup>
                        </div>
                    </div>
                    <div class="grid grid-cols-12 gap-2">
                        ...
                        <div class="col-span-12 md:col-span-9">
                            <InputGroup>
                                ...
                                <Button type="button" class="mr-2 mb-2" icon="pi pi-save" :disabled="disabled" :loading="refs.server.name.loading.value" @click="load($event)" />
                            </InputGroup>
                        </div>
                    </div>
                    <div class="grid grid-cols-12 gap-2">
                        ...
                        <div class="col-span-12 md:col-span-9">
                            <InputGroup>
                                ...
                                <Button type="button" class="mr-2 mb-2" icon="pi pi-save" :disabled="disabled" :loading="refs.server.key.loading.value" @click="load($event)" />
                            </InputGroup>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-12 gap-2">
                        ...
                        <div class="col-span-12 md:col-span-9">
                            <InputGroup>
                                ...
                                <Button type="button" class="mr-2 mb-2" icon="pi pi-upload" :disabled="disabled" :loading="refs.device.ssid.loading.value" @click="load($event)" />
                            </InputGroup>
                        </div>
                    </div>
                    <div class="grid grid-cols-12 gap-2">
                        <label for="device/password" class="flex items-center col-span-12 mb-2 md:col-span-3 md:mb-0">Password</label>
                        <div class="col-span-12 md:col-span-9">
                            <InputGroup>
                                <InputText id="device/password" type="text" v-model="refs.device.password.value" placeholder="Wi-Fi Password" />
                                <Button type="button" class="mr-2 mb-2" icon="pi pi-upload" :disabled="disabled" :loading="refs.device.password.loading.value" @click="load($event)" />
                            </InputGroup>
                        </div>
                    </div>
                    <div class="grid grid-cols-12 gap-2">
                        <label for="device/timezone" class="flex items-center col-span-12 mb-2 md:col-span-3 md:mb-0" >Timezone</label>
                        <div class="col-span-12 md:col-span-9">
                            <InputGroup>
                                <InputText id="device/timezone" type="text" v-model="refs.device.timezone.value" placeholder="POSIX timezone string" />
                                <Button type="button" class="mr-2 mb-2" icon="pi pi-upload" :disabled="disabled" :loading="refs.device.timezone.loading.value" @click="load($event)" />
                            </InputGroup>
                        </div>
                    </div>
                </div>
                ...
                <div class="card flex flex-col gap-4">
                    ...
                    <div class="grid grid-cols-12 gap-2">
                        ...
                        <div class="col-span-12 md:col-span-9">
                            <InputGroup>
                                <Select id="gps/dev" v-model="refs.gps.dev.value" :options="gpsdev" optionLabel="name" placeholder="GPS device" />
                                <Button type="button" class="mr-2 mb-2" icon="pi pi-upload" :disabled="disabled" :loading="refs.gps.dev.loading.value" @click="load($event)" />
                            </InputGroup>
                        </div>
                    </div>
                </div>
            ...
            <div class="md:w-1/2">
                <div class="card flex flex-col gap-4">
                    ...
                    <div class="grid grid-cols-12 gap-2">
                        ...
                        <div class="col-span-12 md:col-span-9">
                            <InputGroup>
                                <Select id="can/bps" v-model="refs.can.bps.value" :options="canbps" optionLabel="name" placeholder="CAN bps" />
                                <Button type="button" class="mr-2 mb-2" icon="pi pi-upload" :disabled="disabled" :loading="refs.can.bps.loading.value" @click="load($event)" />
                            </InputGroup>
                        </div>
                    </div>
                    <div class="grid grid-cols-12 gap-2">
                        ...
                        <div class="col-span-12 md:col-span-9">
                            <InputGroup>
                                ...
                                <Button type="button" class="mr-2 mb-2" icon="pi pi-upload" :disabled="disabled" :loading="refs.can.filter.loading.value" @click="load($event)" />
                            </InputGroup>
                        </div>
                    </div>
                    <div class="grid grid-cols-12 gap-2">
                        ...
                        <div class="col-span-12 md:col-span-9">
                            <InputGroup>
                                ...
                                <Button type="button" class="mr-2 mb-2" icon="pi pi-upload" :disabled="disabled" :loading="refs.can.mask.loading.value" @click="load($event)" />
                            </InputGroup>
                        </div>
                    </div>
                </div>
                ...
                <div class="card flex flex-col gap-4">
                    ...
                    <div class="grid grid-cols-12 gap-2">
                        <label for="digital/enabled" class="flex items-center col-span-12 mb-2 md:col-span-3 md:mb-0">Digital</label>
                        <div class="col-span-12 md:col-span-9">
                ...
                <div class="card flex flex-col gap-4">
                    ...
                    <div class="flex flex-wrap gap-4">
                        ...
                        <Dialog header="Restart Confirmation" v-model:visible="display_restart" :style="{ width: '350px' }" :modal="true">
                            ...
                            <template #footer>
                                <Button label="Restart Device" icon="pi pi-check" @click="restart_device" severity="warn" outlined autofocus />
                            </template>
                        </Dialog>
                        ...
                        <Dialog header="Reset Confirmation" v-model:visible="display_reset" :style="{ width: '350px' }" :modal="true">
                            ...
                            <template #footer>
                                <Button label="RESET DEVICE" icon="pi pi-check" @click="reset_device" severity="danger" outlined autofocus />
                            </template>
                        </Dialog>
                    </div>
                </div>
