<script setup>
  ...
  const sign_options = [{label: 'Unsigned', value: false}, {label: 'Signed', value: true}];
  ...
  function save_cfg() {
    ...
    errors.range = can_cfg.start === '' || can_cfg.end === '' || can_cfg.start < 0 || can_cfg.end < 0 ||
      can_cfg.start > max || can_cfg.end > max || can_cfg.start > can_cfg.end ? `Range must be within 0 ~ ${max}.` : '';
                  ...
                  <div class="mt-3 grid grid-cols-12 gap-2 items-end">
                    <div class="col-span-6">
                      ...
                      <div class="flex items-end mt-1">
                        <input :id="`${key}-mul`" v-model.number="channel.multiplier" type="number" step="0.001"
                          class="w-20 p-inputtext p-component" />
                    ...
                    <div class="col-span-6">
                      ...
                      <Select v-model="channel.unit" :options="unit_options" optionLabel="display" optionValue="name"
                        placeholder="Select unit" class="w-full mt-1" />
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="flex flex-col gap-4">
          ...
          <div class="grid grid-cols-12 gap-2 items-center">
            <div class="col-span-4">
              ...
              <div class="flex items-end mt-1">
                <input id="can_multiplier" v-model.number="can_cfg.multiplier" type="number" step="0.001"
                  class="w-20 p-inputtext p-component" />
                <span class="ml-1 mb-1 text-sm opacity-70">x</span>
              </div>
            </div>
            <div class="col-span-8">
              ...
              <Select v-model="can_cfg.unit" :options="unit_options" optionLabel="display" optionValue="name"
                :invalid="!!errors.unit" placeholder="Select unit" class="w-full mt-1" />
            </div>
          ...
          <div class="grid grid-cols-12 gap-4 items-end">
            <div class="col-span-5">
              ...
              <SelectButton v-model="can_cfg.mode" :options="bitwise_options" optionLabel="label" optionValue="value"
                :allowEmpty="false" class="mt-2" />
            </div>
            <div class="col-start-6 col-span-7">
              <div class="flex items-center gap-2 mt-2">
                #
                <input id="can_range_start" v-model.number="can_cfg.start" type="number"
                  class="w-12 p-inputtext p-component p-filled" :invalid="!!errors.range" />
                <span class="ml-2 mr-2">~</span>
                #
                <input id="can_range_end" v-model.number="can_cfg.end" type="number"
                  class="w-12 p-inputtext p-component p-filled" :invalid="!!errors.range" />
              </div>
            </div>
            ...
            <div class="col-span-9">
              ...
              <SelectButton v-model="can_cfg.sign" :options="sign_options" optionLabel="label" optionValue="value"
                :allowEmpty="false" class="mt-2" />
            </div>
          </div>
